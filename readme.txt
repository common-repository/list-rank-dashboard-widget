...
Without configuration Google PageRank and Alexa Rank are displayed for the current site.
...
= 1.11 =
* Improvement: PHP5 compatibility

= 1.9 =
* Removed [Sustainable Plugins Sponsorship Network](http://pluginsponsors.com/)

= 1.8 =
* Bugfix: updated URL to retrieve Google PageRank
* Improvement: removed Yahoo! rankings, since they are not available anymore
